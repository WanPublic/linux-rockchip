 ...
 * 2. 2026-04-23: 基于 sunnic 4K90 ISM 新增 3864x2192@90fps 并设为默认模式
 */
...
/*
 * IMX415-AAQR All-pixel scan (4K 90fps)
 * CSI-2_4lane
 * 37.125MHz
 * AD:10bit
 * Output:10bit
...
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_2376M_regs[] = {
	...
	{0x30C1, 0x00},
	{0x3115, 0x00},
	/* A/B-TEST(B): 2026-04-24 回退 INCKSEL 组到旧稳定值 */
	{0x3116, 0x23},
	{0x3118, 0x08},
	{0x3119, 0x01},
	{0x311A, 0xE7},
	...
	{0x3BCA, 0xBD},
	{0x4001, 0x03},
	/* A/B-TEST(A): 仅回退 4K90 TXCLKESC_FREQ 到 0x06C0 */
	{0x4004, 0xC0},
	{0x4005, 0x06},
	{0x400C, 0x01},
	{0x4018, 0xE7},
